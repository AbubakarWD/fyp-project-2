<?php
/**
 * BloodLife — Edit Blood Request View
 */
            ...
            <div class="col-lg-8 col-md-10">
                <div class="bl-card bl-card-lg">
                    <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                        <div class="bl-brand-icon bl-brand-icon-lg bl-brand-icon-blue">
                            <i class="bi bi-pencil-square"></i>
                        </div>
                        <div>
                            <h1 class="h3 text-dark mb-0">Edit Blood Request #<?= e($requestId) ?></h1>
                            <p class="text-muted small mb-0">Update patient, hospital, or required date information for this emergency call.</p>
                        </div>
                    </div>
                    ...
                    <form action="<?= APP_URL ?>/request-edit.php?id=<?= $requestId ?>" method="POST" class="needs-validation" novalidate>
                        <?= SecurityHelper::csrfInput() ?>

                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <label class="bl-form-label">Patient Full Name</label>
                                <input type="text" name="patient_name" class="bl-form-control" value="<?= e($formData['patient_name'] ?? '') ?>" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="hospital_name" class="bl-form-control" value="<?= e($formData['hospital_name'] ?? '') ?>" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="contact_number" class="bl-form-control" value="<?= e($formData['contact_number'] ?? '') ?>" required>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="hospital_address" class="bl-form-control" value="<?= e($formData['hospital_address'] ?? '') ?>">
                            </div>

                            <div class="col-md-12">
                                <label class="bl-form-label">Medical Reason / Additional Notes</label>
                                <textarea name="medical_reason" class="bl-form-control" rows="3"><?= e($formData['medical_reason'] ?? '') ?></textarea>
                            </div>
                        </div>

                        <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                            <a href="<?= APP_URL ?>/request-detail.php?id=<?= $requestId ?>" class="bl-btn bl-btn-light">Cancel</a>
